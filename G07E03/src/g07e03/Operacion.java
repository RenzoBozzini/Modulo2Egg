...
public class Operacion {
    ...
    private double numero1; // atributos privados
    private double numero2;

    public Operacion(double numero1, double numero2) { //constructor pasados por parametros
    ...
    public double getNumer02() {
        return numero2;
    }

    public void setNumer02(double numer02) {
        this.numero2 = numer02;
    }
    
    public void crearOperacion(){ //Metodo
    ...
    public double multiplicar(){
        if (numero1 <=0 || numero2 <=0) {
           System.out.println("Error: estas multiplicando por cero. El resultado es:");
           return 0;           
        }
        return numero1*numero2;
    }
    public double dividir(){
        if (numero2 <=0) {
           System.out.println("Error: estas dividiendo por cero. El resultado es:");
           return 0;           
        }
        return numero1/numero2;
    }
