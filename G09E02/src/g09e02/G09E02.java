...
public class G09E02 {
    ...
    public static void main(String[] args) {
        ...
        ps.mostrarValores();
        System.out.println("El numero mayor es el: "+ ps.devolverMayor());
        System.out.println("Si la base es el mayor y el exponente el menor da: " + ps.calcularPotencia());
        System.out.println("La raiz cuadrada del menor numero es: "+ ps.calcularRaiz());
    }    
}
