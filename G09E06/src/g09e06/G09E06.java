...
public class G09E06 {
    ...
    public static void main(String[] args) {
        ...
        CursoServicios servis = new CursoServicios();
        Curso matematicas = new Curso();
        System.out.println("Cree el curso a facturar");
        servis.crearCurso(matematicas);
        System.out.println("Las ganancias son: $"+servis.calcularGananciaSemanal(matematicas) );
